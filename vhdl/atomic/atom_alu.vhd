...
begin
	...
	process(atom_alu_i)
		...
		variable atom_op : atomic_operation_type;
	...
	begin
		...
		if atom_op.atom_amoswap = '1' then
			...
			res := lval or rs2;
		elsif (atom_op.atom_amomin or atom_op.atom_amomin or atom_op.atom_amomin or atom_op.atom_amomin) = '1' then
			res := atom_minmax(lval,rs2,op);
		end if;
